...
- **Performance** : Le contexte contient _beaucoup_ de données (`users`, `classes`, `grades`, etc.). Chaque mise à jour provoque potentiellement un re-render de tous les consommateurs, même s'ils n'utilisent pas la donnée modifiée.
