                ...
                <div className="space-y-4">
                                ...
                                {existingFiles.map((file, index) => (
                                    <div key={index} className="flex items-center justify-between p-3 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <span className="text-xs text-gray-500">({t('homework.alreadyUploaded')})</span>
                                        </div>
                                        <button
                    ...
                    <div className="flex justify-end gap-3 pt-4">
                        ...
                        <Button variant="primary" onClick={onSubmit} disabled={uploadingFiles}>
                            {uploadingFiles ? t('common.loading') : (existingSubmission ? t('common.save') : t('homework.submit'))}
                        </Button>
                    </div>
                </div>
            </div>
