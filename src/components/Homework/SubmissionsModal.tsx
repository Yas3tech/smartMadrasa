                  ...
                  <div className="mb-3">
                    ...
                    <div className="space-y-2">
                      {submission.files.map((file, fileIndex) => (
                        <div
                          key={fileIndex}
                          className="flex items-center justify-between p-2 bg-white dark:bg-slate-600 border border-gray-200 dark:border-slate-500 rounded-lg"
                        >
