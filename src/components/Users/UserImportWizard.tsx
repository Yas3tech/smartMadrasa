...
export default function UserImportWizard({
  ...
  const copy = i18n.language.startsWith('nl')
    ? {
        ...
        pasteDataDesc: 'Plak een tabel met headers name,email,role,phone,birthDate,studentEmail.',
        ...
        fix: 'Te corrigeren',
        reviewHint:
          'Klik in rode cellen om direct te corrigeren zonder terug te gaan naar het bestand.',
        row: 'Rij',
        status: 'Status',
        ready: 'Klaar',
        ...
        progressReview: (valid: number, invalid: number) =>
          `${valid} geldig / ${invalid} corrigeren`,
    ...
    : i18n.language.startsWith('ar')
      ? {
          ...
          pasteDataDesc: 'الصق جدولا بعناوين name,email,role,phone,birthDate,studentEmail.',
          ...
          summaryDesc: 'سيتم انشاء الاسطر الصالحة فقط. وستبقى الاسطر الخاطئة ظاهرة لتصحيحها لاحقا.',
          validRows: 'الاسطر الصالحة',
          excludedRows: 'الاسطر المستبعدة',
          controlTitle: 'التحقق',
          controlDesc: 'يتحقق المعالج من الادوار والبريد والتكرار وربط الولي بالتلميذ قبل الانشاء.',
      ...
      : {
          ...
          progressReview: (valid: number, invalid: number) =>
            `${valid} valide(s) / ${invalid} a corriger`,
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="space-y-3">
            <div>
              ...
              <p className="text-sm text-gray-600">{copy.importFileDesc}</p>
            </div>
            <input
              ref={fileInputRef}
              type="file"
      ...
      <Card className="p-6 border border-blue-100 bg-gradient-to-br from-blue-50 to-white">
        <div className="flex items-start gap-4">
          ...
          <div className="w-full space-y-3">
            <div>
              <h3 id="import-paste-data-title" className="text-lg font-semibold text-gray-900">
                {copy.pasteData}
              </h3>
              <p className="text-sm text-gray-600">{copy.pasteDataDesc}</p>
            </div>
            <textarea
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="space-y-3">
            <div>
              ...
              <p className="text-sm text-gray-600">{copy.summaryDesc}</p>
            </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="space-y-3">
            <div>
              ...
              <p className="text-sm text-gray-600">{copy.controlDesc}</p>
            </div>
