      ...
      <div className="lg:hidden -mx-4 -mt-6 bg-gradient-to-r from-orange-500 to-orange-600 p-6 rounded-b-[2rem] shadow-lg mb-6 text-white">
        <div className="flex justify-between items-center mb-4">
          ...
          <button
            ...
            className={`p-2 rounded-lg bg-orange-700/30 backdrop-blur-md border border-white/20 focus:outline-none focus-visible:ring-2 focus-visible:ring-white/50 ${!tg.selectedClassId ? 'opacity-50 cursor-not-allowed' : 'active:scale-95 transition-transform'}`}
                          ...
                          {tg.editingGrade?.id === grade.id ? (
                            <div className="flex justify-end gap-2">
                              <button
                                ...
                                className="p-1 text-green-600 hover:bg-green-50 rounded focus:outline-none focus-visible:ring-2 focus-visible:ring-green-500"
                                title={t('common.save')}
                              ...
                              <button
                                ...
                                className="p-1 text-red-600 hover:bg-red-50 rounded focus:outline-none focus-visible:ring-2 focus-visible:ring-red-500"
                            ...
                            <button
                              ...
                              className="p-1 text-gray-400 hover:text-indigo-600 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 rounded"
                              title={t('common.edit')}
