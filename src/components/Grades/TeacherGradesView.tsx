      ...
      <div className="lg:hidden -mx-4 -mt-6 bg-gradient-to-r from-orange-500 to-orange-600 p-6 rounded-b-[2rem] shadow-lg mb-6 text-white">
        <div className="flex justify-between items-center mb-4">
          ...
          <button
            ...
            className={`p-2 rounded-lg bg-orange-700/30 backdrop-blur-md border border-white/20 focus-visible:ring-2 focus-visible:ring-orange-500 focus:outline-none ${!tg.selectedClassId ? 'opacity-50 cursor-not-allowed' : 'active:scale-95 transition-transform'}`}
          >
            <Upload size={20} />
          </button>
        </div>
                          ...
                          {tg.editingGrade?.id === grade.id ? (
                            <div className="flex justify-end gap-2">
                              <button
                                ...
                                className="p-1 text-green-600 hover:bg-green-50 rounded focus-visible:ring-2 focus-visible:ring-green-500 focus:outline-none"
                              >
                                <Check size={18} />
                              </button>
                              <button
                            ...
                            <button
                              ...
                              className="p-1 text-gray-400 hover:text-indigo-600 transition-colors focus-visible:ring-2 focus-visible:ring-indigo-500 focus:outline-none"
                            >
                              <Pencil size={18} />
                            </button>
                          )}
