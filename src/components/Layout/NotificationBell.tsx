  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      <button
        ...
        className="relative p-2 text-gray-600 dark:text-slate-400 hover:text-orange-600 dark:hover:text-orange-400 hover:bg-orange-50 dark:hover:bg-orange-900/30 rounded-xl transition-all duration-200 group focus:outline-none focus-visible:ring-2 focus-visible:ring-orange-500 focus-visible:rounded-xl"
            ...
            <div className="flex items-center gap-2">
              {unreadCount > 0 && (
                <button
                  ...
                  className="text-xs font-medium text-orange-600 hover:text-orange-700 underline focus:outline-none focus-visible:ring-2 focus-visible:ring-orange-500 focus-visible:rounded-sm"
                >
              ...
              <button
                ...
                className="p-1 text-gray-400 dark:text-slate-500 hover:text-gray-600 dark:hover:text-slate-300 hover:bg-white dark:hover:bg-slate-700 rounded-lg transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-orange-500 focus-visible:rounded-lg"
