...
const Sidebar = ({ isCollapsed }: SidebarProps) => {
  ...
  return (
    <aside
      className={`bg-white dark:bg-slate-900 ${isRTL ? 'border-l rtl:border-l' : 'border-r'} border-gray-100 dark:border-slate-700 h-screen flex flex-col fixed ${isRTL ? 'right-0' : 'left-0'} top-0 z-50 shadow-soft transition-all duration-300 ${
    ...
    >
      ...
      <Link
        to="/"
        className="p-4 flex items-center justify-center hover:bg-gray-50 dark:hover:bg-slate-800 transition-colors rounded-xl mx-2 mt-2"
      >
        <img
          src="/logo.png"
          alt="SmartMadrassa"
      ...
      <div className="p-4 border-t border-gray-100 dark:border-slate-700">
        ...
        <button
          onClick={logout}
          className={`flex items-center gap-2 text-sm text-red-500 hover:text-red-600 w-full px-2 py-2 rounded-lg hover:bg-red-50 dark:hover:bg-red-900/10 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-orange-500 ${
