          ...
          <div className="flex flex-col items-center min-w-[200px]">
            ...
            {!schedule.isCurrentWeek && (
              <button
                ...
                className="text-xs text-orange-600 hover:text-orange-700 mt-1 font-medium focus:outline-none focus-visible:ring-2 focus-visible:ring-orange-500 focus-visible:rounded-sm"
              >
                            ...
                            visibleCourses.map((ci) => {
                              ...
                              return (
                                <div
                                  ...
                                  onClick={() =>
                                    schedule.canEdit && schedule.handleEditCourse(ci.course)
                                  }
                                >
                                  ...
                                  {ci.course.room && (
                                    <div className="opacity-70 text-[10px]">{ci.course.room}</div>
                                  )}
                                  ...
                                  {schedule.canEdit && (
                                    <button
                                      className="absolute -top-1 -right-1 p-1 bg-white dark:bg-slate-700 rounded-full shadow opacity-0 group-hover:opacity-100 focus-visible:opacity-100 text-gray-500 hover:text-red-500 focus:outline-none focus-visible:ring-2 focus-visible:ring-orange-500"
                                      onClick={(e) =>
                                        schedule.showDeleteMenu(e, ci.course.id, dateStr)
                                      }
