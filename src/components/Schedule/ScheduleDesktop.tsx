                                                    ...
                                                    {visibleCourses.length > 0 && visibleCourses.map((ci) => {
                                                        ...
                                                        return (
                                                            ...
                                                            >
                                                                ...
                                                                {schedule.canEdit && (
                                                                    <button
                                                                        className="absolute -top-1 -right-1 p-1 bg-white dark:bg-slate-700 rounded-full shadow opacity-0 group-hover:opacity-100 focus-visible:opacity-100 focus:outline-none focus-visible:ring-2 focus-visible:ring-red-500 text-gray-500 hover:text-red-500"
