...
import { ChevronLeft, Reply as ReplyIcon, Forward as ForwardIcon, Archive, Trash2, Paperclip, File, Inbox } from 'lucide-react';
                    ...
                    <div className="p-4 border-b border-gray-100 dark:border-slate-700 flex justify-between items-center">
                        <div className="flex items-center gap-2">
                            ...
                            <div className="flex gap-2">
                                ...
                                <button
                                    className={`p-2 transition-colors rounded-lg focus:outline-none focus-visible:ring-2 focus-visible:ring-orange-500 ${selectedMessage.archived ? 'text-gray-400 hover:text-blue-600 hover:bg-blue-50' : 'text-gray-400 hover:text-orange-600 hover:bg-orange-50'}`}
                                    onClick={() => handleArchiveMessage(selectedMessage.id)}
                                    title={selectedMessage.archived ? 'Désarchiver' : t('messages.archive')}
                                    aria-label={selectedMessage.archived ? 'Désarchiver' : t('messages.archive')}
                                >
                                    <Archive size={18} />
                                </button>
                                <button
