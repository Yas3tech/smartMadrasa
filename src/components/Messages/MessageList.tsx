        ...
        >
            <div className="p-4 border-b border-gray-100 dark:border-slate-700 bg-white dark:bg-slate-800">
                <div className="flex items-center gap-2 mb-2">
                    {isMobile && (
                        <button
                            ...
                            className="p-1 mr-2 -ml-2 text-gray-500 focus:outline-none focus-visible:ring-2 focus-visible:ring-orange-500 focus-visible:rounded-lg"
                ...
                <div className="flex gap-2">
                    ...
                    <button
                        className="p-2 text-gray-400 dark:text-slate-500 hover:bg-gray-100 dark:hover:bg-slate-700 rounded-lg focus:outline-none focus-visible:ring-2 focus-visible:ring-orange-500 focus-visible:rounded-lg"
