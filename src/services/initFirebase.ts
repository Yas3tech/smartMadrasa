...
const teachersData = [
  {
    id: 'teacher-1',
    name: 'M. Amine Benjelloun',
    email: 'amine.benjelloun@school.ma',
    role: 'teacher',
    avatar: '👨‍🏫',
  ...
  {
    id: 'teacher-2',
    name: 'Mme. Layla El Amrani',
    email: 'layla.elamrani@school.ma',
    role: 'teacher',
    avatar: '👩‍🏫',
  ...
  {
    id: 'teacher-3',
    name: 'M. Youssef Idrissi',
    email: 'youssef.idrissi@school.ma',
    role: 'teacher',
    avatar: '👨‍🏫',
    subjects: ['Arabe', 'Religion'],
  },
];
...
const parentsData = [
  {
    id: 'parent-1',
    name: 'M. et Mme. Alami',
    email: 'famille.alami@gmail.com',
    role: 'parent',
    avatar: '👨‍👩‍👧‍👦',
  },
  {
    id: 'parent-2',
    name: 'M. et Mme. Berrada',
    email: 'famille.berrada@gmail.com',
    role: 'parent',
    avatar: '👨‍👩‍👦',
  },
...
const directorsData = [
  {
    id: 'director-1',
    name: 'Dr. Hassan El Fassi',
    email: 'hassan.elfassi@school.ma',
    role: 'director',
    avatar: '👨‍💼',
  },
  {
...
export const initializeFirebaseData = async () => {
  ...
  try {
    ...
    for (const [oldParentId, oldChildrenIds] of Object.entries(parentChildrenMap)) {
      ...
      if (parentUid) {
        const childrenDetails = oldChildrenIds
          .map((id) => {
    ...
    for (const c of classesData) {
      ...
      for (const day of days) {
        ...
        for (let i = 0; i < slotIndexesForDay.length; i++) {
          ...
          await setDoc(doc(db, 'classes', c.id, 'courses', courseId), course);
        }
      }
    }
