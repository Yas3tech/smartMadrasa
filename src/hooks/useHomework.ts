...
export function useHomework(): UseHomeworkReturn {
    ...
    const handleCreateHomework = async () => {
        const { title, dueDate, selectedClassId, subject, description, allowOnlineSubmission, maxGrade } = formState;
    ...
    return {
        ...
        isSubmissionsModalOpen, setIsSubmissionsModalOpen,
        selectedHomework, setSelectedHomework,
        editingHomework,
        showPastHomework, setShowPastHomework,
        mobileTab, setMobileTab,
        selectedChild, setSelectedChild,
        submissions,
        studentSubmissions,
        formState, setFormField,
        submissionContent, setSubmissionContent,
