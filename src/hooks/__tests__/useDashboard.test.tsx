...
describe('useDashboard', () => {
  ...
  it('should return dashboard data correctly', () => {
    ...
    vi.mocked(useAuth).mockReturnValue({ user: mockUser as unknown as ReturnType<typeof useUsers> } as ReturnType<typeof useAuth>);
  ...
  it('should calculate complex stats correctly', () => {
    ...
    vi.mocked(useAuth).mockReturnValue({ user: mockUser as unknown as ReturnType<typeof useAcademics> } as ReturnType<typeof useAuth>);
    vi.mocked(useUsers).mockReturnValue({
      students: [],
      users: [],
    } as unknown as ReturnType<typeof usePerformance>);
