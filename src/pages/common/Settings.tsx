...
const Settings = () => {
  ...
  useAuth();
  const languageLabels = i18n.language.startsWith('nl')
    ? { fr: 'Frans', nl: 'Nederlands', ar: 'Arabisch' }
    : i18n.language.startsWith('ar')
      ? { fr: 'الفرنسية', nl: 'الهولندية', ar: 'العربية' }
      : { fr: 'Francais', nl: 'Nederlands', ar: 'Arabe' };
            ...
            <div className="space-y-4">
              <div className="p-4 bg-gray-50 dark:bg-slate-700/50 rounded-xl">
                ...
                >
                  ...
                  <option value="nl">{languageLabels.nl}</option>
