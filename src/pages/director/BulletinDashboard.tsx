        ...
        classes.forEach(cls => {
            ...
            classStudents.forEach(student => {
                classCourses.forEach(course => {
                    totalExpected++;
                    const comment = periodComments.find(c =>
                    ...
                    <div className="bg-white rounded-lg shadow-md p-6">
                        ...
                        <div className="space-y-3">
                            {classes.map((classItem) => {
                                const stats = classStats[classItem.id] || { total: 0, validated: 0, isFullyValidated: false };
                                const isValidated = stats.isFullyValidated;
                                const progress = stats.total > 0 ? Math.round((stats.validated / stats.total) * 100) : 0;
