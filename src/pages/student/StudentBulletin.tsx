...
import { useUsers, useAcademics, usePerformance } from '../../hooks/useData';
                ...
                <div className="flex justify-between items-center">
                  <div>
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                      {t('bulletin.publishedOn')}{' '}
                      {selectedPeriodData.bulletinPublishDate
