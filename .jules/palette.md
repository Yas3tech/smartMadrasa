...
## 2025-05-24 - Button Component Missing Focus Indicators

**Learning:** The foundational `Button` component lacked `focus-visible` styles, making keyboard navigation difficult across the entire application as focus states were invisible.
**Action:** Ensure all interactive UI elements include `focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-500 focus-visible:ring-offset-2 dark:focus-visible:ring-offset-slate-900` to provide clear, accessible focus rings for keyboard users without affecting mouse users.
